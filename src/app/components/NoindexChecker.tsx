...
const tooltips = {
	meta: (
		<div>
			...
			<p>
				Meta tags are HTML elements that provide information about a
				webpage. The &quot;noindex&quot; meta tag tells search engines
	...
	robots: (
		<div>
			...
			<p>
				The robots.txt file is a text file that tells search engines
				which pages they can or can&apos;t request from your site.
			</p>
			<p className='mt-2 text-xs'>
				Example: <code>User-agent: *\nDisallow: /private/</code>
			</p>
		</div>
	),
	implications: (
		<div>
			...
			<p>
				If noindex is found, search engines will not include these pages
				in their search results. This is useful for:
			</p>
	...
	metaTagList: (
		<div>
			...
			<p>
				These are the meta tags found on your page. Look for tags
				containing &quot;robots&quot; or &quot;noindex&quot; to see if
				indexing is blocked.
			</p>
		</div>
	),
	robotsContent: (
		<div>
			...
			<p>
				This is the content of your robots.txt file. It shows which
				pages search engines are allowed or disallowed from crawling.
			</p>
		</div>
	),
};
...
export default function NoindexChecker() {
	...
	return (
		<div className='bg-white rounded-lg shadow-lg p-6'>
			...
			<p className='text-[#22292f] mb-6'>
				Check if your website is properly configured for search engine
				indexing by verifying meta tags and robots.txt settings.
			</p>
						...
						<div className='bg-gray-50 p-4 rounded-lg'>
							...
							<div className='space-y-2'>
								{result.metaTags.map((tag, index) => (
									<div
										key={index}
										className='text-sm font-mono bg-white p-2 rounded text-[#22292f]'
									>
										{tag}
									</div>
								))}
					...
					{result.robotsTxtContent && (
						<div className='bg-gray-50 p-4 rounded-lg'>
							<div className='flex items-center gap-2 mb-2'>
								...
								<Tooltip
									content={tooltips.robotsContent}
									icon
								/>
							</div>
							<pre className='text-sm font-mono bg-white p-4 rounded overflow-x-auto text-[#22292f]'>
								{result.robotsTxtContent}
							</pre>
						</div>
					)}
